...
<CENTER>
  <A href="interviewer_app_diagnostics.png">
...
<P>The Interviwer App will try to connect to the synchronization point 
...
<P>Use this to diagnose the connetivity to the server issues, and quality
...
for review to the ADMIN user only. The tablet must be online for this
feature to succeed.</P>
