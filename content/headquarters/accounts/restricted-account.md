...
The restriction is applicable to any user role and is given a priority over the "*Enable profile editing*" setting in the [workspace settings](/headquarters/config/admin-settings/#user-profile-settings).
...
The [support tool](/headquarters/config/support-tool/) can be used to reset the password or 2FA of any user, regardless of whether the corresponding account was marked as *restricted*.